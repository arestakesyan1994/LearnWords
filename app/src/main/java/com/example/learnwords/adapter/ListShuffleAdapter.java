...
public class ListShuffleAdapter extends BaseAdapter implements SectionIndexer {
    Context context;
    ArrayList<String> ID;
    ArrayList<String> EN;
    ArrayList<String> HY;
    ...
    public ListShuffleAdapter(Context context, ArrayList<String> ID, ArrayList<String> EN, ArrayList<String> HY, ArrayList<String> PRON, ArrayList<String> EXAMPLE) {
    ...
    public View getView(final int position, View child, ViewGroup parent) {
        ...
        if (child == null) {
            ...
            child = layoutInflater.inflate(R.layout.item_shuffle, null);
            word = new Word();
